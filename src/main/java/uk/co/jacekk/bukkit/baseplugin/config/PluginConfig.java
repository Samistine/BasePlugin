...
/**
 * The configuration of a plugin, this represents the config.yml (or other name)
 * file.
 *
...
public class PluginConfig {
    ...
    /**
     * Creates a new config object that can be used to fetch the value of a
     * {@link PluginConfigKey}
     *
     * @param configFile	The file to be used to store this configuration
     * (usually config.yml).
     * @param configDefaults	The default configuration options to be used if an
     ...
     * (usually config.yml).
     *
     * @param configDefaults The class holding the default configuration options
     * to be used if an entry cannot be found.
     *
     * @param log	The {@link PluginLogger} to be used for any messages.
     */
    public PluginConfig(File configFile, Class<?> configHolder, Logger log) {
        ArrayList<PluginConfigKey> config = new ArrayList<>();
    ...
    private void updateFile() {
        ...
        if (updateNeeded) {
            try {
                ...
                this.log.log(Level.INFO, "The {0} file has been updated.", configFile.getName());
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
     ...
     *
     * @param configKey	The {@link PluginConfigKey} to get the value of.
     * @return	The list of integer values or an empty list if the key does no
     * exist.
     */
     ...
     *
     * @param configKey	The {@link PluginConfigKey} to get the value of.
     * @return	The list of double values or an empty list if the key does no
     * exist.
     */
    @SuppressWarnings("unchecked")
     ...
     *
     * @param configKey	The {@link PluginConfigKey} to get the value of.
     * @return	The list of long values or an empty list if the key does no
     * exist.
     */
    @SuppressWarnings("unchecked")
     ...
     *
     * @param configKey	The {@link PluginConfigKey} to get the value of.
     * @return	The list of string values or an empty list if the key does no
     * exist.
     */
    @SuppressWarnings("unchecked")
     ...
     *
     * @param configKey	The {@link PluginConfigKey} to set, this must be defined
     * in the original option list.
