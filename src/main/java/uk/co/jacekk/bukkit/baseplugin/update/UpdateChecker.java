...
/**
 * A class to check for updates of the plugin. A specific updater must extend
 * this and provide the method to check for updates.
 *
...
public abstract class UpdateChecker {
    ...
    /**
     * Gets the URL for the page where the latest version can be downloaded
     * from.
     *
     * @return	The URL.
     */
