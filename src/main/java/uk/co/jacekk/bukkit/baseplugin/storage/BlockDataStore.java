...
public class BlockDataStore<T extends Serializable> extends BaseListener<BasePlugin> {
    ...
    void onChunkLoad(ChunkLoadEvent event) {
        ...
        if (chunkFile.exists()) {
            try {
                try (ObjectInputStream input = new ObjectInputStream(new FileInputStream(chunkFile))) {
    ...
    void onChunkUnload(ChunkUnloadEvent event) {
        ...
        if (chunkData != null) {
            ...
            try {
                try (ObjectOutputStream output = new ObjectOutputStream(new FileOutputStream(chunkFile))) {
